        ...
        <div className={`flex flex-col h-full relative ${variant === 'split' ? 'p-8' : ''}`}>
            {variant === 'modal' ? (
                <div className="flex items-center justify-between sticky top-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md z-10 px-8 py-6 border-b border-gray-100 dark:border-slate-700">
                    ...
                    {onClose && (
                        <button onClick={onClose} className="text-gray-400 hover:text-rose-500 transition-all duration-300 bg-gray-50 dark:bg-slate-700 hover:bg-rose-50 dark:hover:bg-rose-900/30 p-1.5 rounded-full shadow-sm outline-none focus:outline-none focus:ring-0 active:outline-none">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        <div className="col-span-2">
                            ...
                            {doctor.user?.email ? (
                                <a 
                                    ...
                                    className="font-bold text-gray-900 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                >
                                    {doctor.user.email}
                                </a>
                            ) : (
                        ...
                        <div>
                            ...
                            {doctor.tel ? (
                                <a 
                                    ...
                                    className="inline-flex items-center font-bold text-gray-900 dark:text-slate-100 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors group"
                        ...
                        <div className="col-span-2 pt-4 border-t border-gray-50 dark:border-slate-700 mt-2">
                            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3.5 border border-blue-100 dark:border-blue-800/40 flex items-start gap-3">
                                ...
                                <div>
                                    <h5 className="text-xs font-bold text-blue-800 dark:text-blue-300 uppercase tracking-wider">Verified Medical Staff</h5>
