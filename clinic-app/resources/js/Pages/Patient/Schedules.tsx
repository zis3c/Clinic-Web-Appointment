...
export default function Schedules({ auth, schedules }: any) {
    ...
    const selectedDateSchedules = filteredSchedules.filter((s: any) => s.date === selectedDate);
                        ...
                        <div className="lg:col-span-2 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col h-full overflow-hidden">
                            ...
                            <div className="grid grid-cols-7 gap-2 flex-1">
                                {calendarDays.map((day, idx) => {
                                    ...
                                    const daySchedules = filteredSchedules.filter((s: any) => s.date === dayStr);
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`p-2 rounded-2xl border text-center flex flex-col justify-between items-center cursor-pointer transition-all min-h-[50px] relative ${
                                                isSelected 
                                        ...
                                        >
                                            ...
                                            {daySchedules.length > 0 && (
                                                <span className={`w-2.5 h-2.5 rounded-full flex items-center justify-center mt-1.5 shadow-sm ${
                                                    isSelected ? 'bg-white' : 'bg-gradient-to-tr from-teal-400 to-blue-500'
                                            ...
                                            >
                                                ...
                                                <div className="border-t border-slate-100/50 pt-2 flex justify-between items-center text-xs">
                                                    ...
                                                    <button
                                                        onClick={() => openBookingModal(schedule)}
                                                        disabled={isFull || hasBooked}
                                                        className={`py-1.5 px-3 rounded-lg font-black text-[10px] shadow-sm transition-all ${
                                                            isFull || hasBooked 
                                    ...
                                    {selectedSchedule && (
                                        <>
                                            <div className="text-center mb-6">
                                                ...
                                                <p className="text-gray-500 mt-2">Book your consultation session:</p>
                                            </div>
                                            ...
                                            <form onSubmit={submitBooking}>
                                                {errors.schedule_id && (
                                                    <div className="mb-4 p-3 bg-rose-50 text-rose-600 text-xs rounded-lg border border-rose-100">
                                                        {errors.schedule_id}
                                                    </div>
                                                )}
                                                ...
                                                {/* Time Slots Selector */}
                                                <div className="mb-5">
                                                    <label className="block text-[10px] font-black uppercase tracking-wider text-slate-400 mb-2">Select a Time Slot</label>
                                                        ...
                                                        {generateTimeSlots(selectedSchedule).map((slot: string) => {
                                                            ...
                                                            return (
                                                                <button
                                                                    ...
                                                                    className={`py-2 px-2.5 rounded-xl border text-[11px] font-bold transition-all text-center flex flex-col items-center justify-center gap-0.5 ${
                                                                        isBooked 
                                                                ...
                                                                >
                                                                    ...
                                                                    <span className={`text-[8px] ${isBooked ? 'text-slate-400 font-medium' : isSelected ? 'text-blue-100 font-medium' : 'text-emerald-600 font-black'}`}>
                                                ...
                                                <div className="mb-5 flex items-start gap-3 bg-teal-50/50 p-4 rounded-xl border border-teal-100/50">
                                                    <input 
                                                        type="checkbox" 
                                                        id="confirm-checkbox"
                                                    ...
                                                    />
                                                    <label htmlFor="confirm-checkbox" className="text-[10px] text-slate-600 select-none cursor-pointer leading-relaxed">
