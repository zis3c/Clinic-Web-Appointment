        ...
        >
            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-colors">
                    <div>
                        <h3 className="text-lg font-bold text-gray-800 dark:text-slate-100">Your Medical History</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">View your past clinic visits, diagnoses, and doctor's prescriptions.</p>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                        <div className="relative flex-1 sm:flex-none">
                            ...
                            <input
                                ...
                                className="h-11 pl-10 pr-4 border border-gray-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all w-full bg-gray-50 dark:bg-slate-900/50 text-gray-700 dark:text-slate-200 cursor-pointer"
                            />
                            {filterDate && (
                                <button 
                                    ...
                                    <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 md:p-6 shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-md transition-all duration-300">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="bg-rose-50/50 dark:bg-rose-900/10 rounded-xl p-4 border border-rose-100 dark:border-rose-900/30">
                                                <h4 className="text-xs font-bold text-rose-800 dark:text-rose-400 mb-1.5 uppercase tracking-wider flex items-center gap-1.5">
                                            ...
                                            <div className="bg-amber-50/50 dark:bg-amber-900/10 rounded-xl p-4 border border-amber-100 dark:border-amber-900/30">
                                                <h4 className="text-xs font-bold text-amber-800 dark:text-amber-400 mb-1.5 uppercase tracking-wider flex items-center gap-1.5">
                                            ...
                                            {apt.notes && (
                                                <div className="bg-gray-50 dark:bg-slate-900/50 rounded-xl p-4 border border-gray-200 dark:border-slate-700">
                                                    <h4 className="text-xs font-bold text-gray-700 dark:text-gray-400 mb-1.5 uppercase tracking-wider flex items-center gap-1.5">
