...
export default function Edit({ auth, mustVerifyEmail, status }) {
    ...
    return (
        ...
        >
            ...
            <div className="h-[calc(100vh-180px)] min-h-[500px] w-full flex flex-col md:flex-row bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden max-w-7xl mx-auto">
                        ...
                        {activeTab === 'logout' && (
                            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                                ...
                                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                                    <h4 className="text-lg font-bold text-gray-800 mb-2">Log out of your account</h4>
                                    <p className="text-sm text-gray-600 mb-6">
                                        End your current session. You will be prompted for your credentials the next time you access the clinic portal.
                                    </p>
                                    <Link 
                                        method="post" 
                                        href={route('logout')} 
                                        as="button" 
                                        className="inline-flex items-center px-6 py-3 bg-blue-600 border border-transparent rounded-xl font-bold text-sm text-white shadow-sm hover:shadow hover:bg-blue-700 transition-all focus:outline-none"
                                    >
