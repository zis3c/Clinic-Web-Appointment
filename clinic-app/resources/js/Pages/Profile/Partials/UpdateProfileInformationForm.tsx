        ...
        <section className={className}>
            ...
            <div className="mt-6 flex items-center gap-6 pb-6 border-b border-gray-100 dark:border-slate-700">
                <div className="relative group shrink-0">
                    <div className="h-20 w-20 rounded-full overflow-hidden bg-gradient-to-tr from-teal-400 to-blue-500 flex items-center justify-center text-white text-3xl font-bold shadow-sm border-2 border-gray-100 dark:border-slate-700">
                        {user.avatar ? (
                            <img 
                    ...
                    >
                        ...
                        <span className="text-[9px] font-bold capitalize tracking-wider">Change</span>
                    </button>
                    ...
                    <div>
                        <p className="mt-2 text-sm text-gray-800 dark:text-gray-300">
                            ...
                            <Link
                                ...
                                method="post"
                                as="button"
                                className="rounded-md text-sm text-gray-600 dark:text-gray-400 underline hover:text-gray-900 dark:hover:text-gray-200 outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                            >
