        ...
        >
            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-colors">
                    <div>
                        <h3 className="text-lg font-bold text-gray-800 dark:text-slate-100">Consultation History</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">View your past completed consultations with patients, diagnoses, and prescriptions.</p>
                    </div>
