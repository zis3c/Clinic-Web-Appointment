...
export default function Dashboard({ auth, schedules = [], stats = { total_appointments: 0, total_schedules: 0, total_patients: 0 }, recent_appointments = [] }) {
    const [selectedSession, setSelectedSession] = useState(null);

    // Get only future schedules
    const upcomingSchedules = (schedules || []).filter(s => new Date(s.date) >= new Date().setHours(0,0,0,0));
