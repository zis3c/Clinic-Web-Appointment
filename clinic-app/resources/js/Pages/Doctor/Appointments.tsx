                                                    ...
                                                    <div className="flex items-center justify-end gap-2.5">
                                                        ...
                                                        {!!appointment.checked_in && appointment.status === 'confirmed' && (
                                                            <button
                                                                ...
                                                                className="text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 bg-teal-50 dark:bg-teal-900/30 hover:bg-teal-100 dark:hover:bg-teal-900/50 p-2 rounded-xl transition-all cursor-pointer shadow-sm hover:scale-105 active:scale-95"
                                                            >
                                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
