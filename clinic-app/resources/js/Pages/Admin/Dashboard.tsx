            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4 h-[calc(100vh-140px)] lg:h-[calc(100vh-70px)] flex flex-col overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 flex-shrink-0">
                    ...
                    <div className="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-100 p-4 group hover:shadow-xl hover:shadow-blue-500/5 hover:-translate-y-0.5 transition-all duration-300">
                        ...
                        <div className="flex items-center justify-between relative z-10">
                            <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Total Doctors</p>
                                <h3 className="text-3xl font-black text-gray-900 tracking-tight">{doctorCount}</h3>
                            </div>
                    ...
                    <div className="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-100 p-4 group hover:shadow-xl hover:shadow-teal-500/5 hover:-translate-y-0.5 transition-all duration-300">
                        ...
                        <div className="flex items-center justify-between relative z-10">
                            <div>
                                ...
                                <h3 className="text-3xl font-black text-gray-900 tracking-tight">{patientCount}</h3>
                            </div>
                    ...
                    <div className="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-100 p-4 group hover:shadow-xl hover:shadow-purple-500/5 hover:-translate-y-0.5 transition-all duration-300">
                        ...
                        <div className="flex items-center justify-between relative z-10">
                            <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Appointments</p>
                                <h3 className="text-3xl font-black text-gray-900 tracking-tight">{appointmentCount}</h3>
                            </div>
                    ...
                    <div className="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-100 p-4 group hover:shadow-xl hover:shadow-amber-500/5 hover:-translate-y-0.5 transition-all duration-300">
                        ...
                        <div className="flex items-center justify-between relative z-10">
                            <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Active Schedules</p>
                                <h3 className="text-3xl font-black text-gray-900 tracking-tight">{scheduleCount}</h3>
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-0">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden flex flex-col lg:col-span-2 h-full min-h-0">
                        <div className="px-6 py-3.5 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-gray-50 to-white flex-shrink-0">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">Monitor and validate patient arrivals</p>
                            </div>
                            <Link href={route('admin.appointments.index')} className="text-xs font-bold text-blue-600 hover:text-blue-700 bg-blue-50 px-3 py-1.5 rounded-xl transition-all hover:bg-blue-100">
                                Manage All
                            </Link>
                        </div>
                                    ...
                                    {appointments.map((apt: any) => (
                                        <div key={apt.id} className="py-3 first:pt-1.5 last:pb-1.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                            <div className="flex items-center space-x-3.5">
                                                ...
                                                <div>
                                                    <h4 className="text-sm font-bold text-gray-900">{apt.patient?.user?.name || 'Unknown Patient'}</h4>
                                            ...
                                            <div className="flex items-center gap-2.5 self-end sm:self-auto">
                                                <div className="flex items-center gap-1.5">
                                                    {!!apt.checked_in && (
                                                        <span className="inline-flex items-center px-2.5 py-1.5 rounded-lg text-[10px] font-black bg-teal-50 text-teal-700 border border-teal-200/50 shadow-sm">
                                                            Arrived
                                                        </span>
                                                    )}
                                                ...
                                                {apt.status !== 'rejected' && apt.status !== 'completed' && !apt.checked_in && (
                                                    <Link
                                                        ...
                                                        as="button"
                                                        preserveScroll
                                                        className="px-3 py-1.5 text-[10px] font-black bg-teal-50 hover:bg-teal-100 text-teal-700 border border-teal-200/50 rounded-lg shadow-sm hover:scale-105 active:scale-95 transition-all cursor-pointer"
                                                    >
                                                        Check In
                                                    </Link>
                                                )}
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-5 flex flex-col justify-between h-full min-h-0">
                        ...
                        <div className="bg-teal-50 border border-teal-100 rounded-2xl p-4 flex items-center space-x-3 mt-4 flex-shrink-0">
                            ...
                            <div>
                                <h5 className="text-xs font-bold text-teal-800">Check-in Server Online</h5>
                                <p className="text-[10px] text-teal-600 font-semibold mt-0.5">Direct arrivals check-in enabled.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-8">
                    ...
                    <div className="w-full text-center relative mb-6">
                        <button 
                            ...
                            className="absolute -top-2 right-0 text-gray-400 hover:text-gray-600 transition-colors p-1.5 hover:bg-gray-100 rounded-full"
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M6 18L18 6M6 6l12 12"></path>
                            </svg>
                        </button>
                        <h3 className="text-2xl font-black text-gray-900 tracking-tight">Manual Patient Check-in</h3>
                        <p className="text-xs text-gray-500 mt-1">Lookup and check in patient by Name, IC/NIC, or Code</p>
                    </div>
                    ...
                    <form onSubmit={handleCheckInSubmit} className="space-y-4">
                        <div className="relative z-30" ref={dropdownRef}>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full h-11 px-4 border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 rounded-xl text-sm focus:outline-none transition-colors"
                                />
                                {isSearching && (
                            ...
                            {searchResults.length > 0 && (
                                <div className="absolute z-50 w-full mt-1 bg-white border border-gray-100 rounded-2xl shadow-xl max-h-60 overflow-y-auto custom-scrollbar divide-y divide-gray-50">
                                    {searchResults.map((apt) => (
                                        <div
                                            key={apt.id}
                                            onClick={() => handleSelectResult(apt)}
                                            className="px-5 py-4 hover:bg-blue-50/50 cursor-pointer transition-colors text-left flex justify-between items-center"
                                        >
                                            <div>
                                                <h4 className="text-sm font-bold text-gray-900">{apt.patient_name}</h4>
                                            ...
                                            <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-black bg-blue-50 text-blue-700 border border-blue-100 shadow-sm">
                                                Active
                                            </span>
                                        </div>
                                    ))}
                            ...
                            {searchQuery.length >= 2 && searchResults.length === 0 && !isSearching && !selectedAppointment && (
                                <div className="absolute z-50 w-full mt-1 bg-white border border-gray-100 rounded-2xl shadow-xl p-4 text-center text-xs text-gray-400">
                        ...
                        {selectedAppointment && (
                            <div className="bg-teal-50/50 border border-teal-100/50 rounded-2xl p-4 text-left space-y-2 animate-fadeIn">
                                <div className="flex justify-between items-start">
                                    <div>
                                        <p className="text-[9px] font-black text-teal-800 uppercase tracking-wider">Selected Patient</p>
                                        <h4 className="text-sm font-black text-gray-900 mt-0.5">{selectedAppointment.patient_name}</h4>
                                        <p className="text-xs text-gray-500 mt-0.5">IC/NIC: <span className="font-semibold text-gray-700">{selectedAppointment.patient_nic}</span></p>
                                    </div>
                                    <span className="px-2.5 py-1 text-[9px] font-black bg-teal-500 text-white rounded-lg shadow-sm">
                                        Ready
                                    </span>
                                </div>
                                <div className="border-t border-teal-100/50 pt-2 flex justify-between text-xs text-gray-600 font-medium">
                                    <div>
                                        <span className="text-gray-400">Doctor:</span> Dr. {selectedAppointment.doctor_name}
                                    </div>
                                    <div>
                        ...
                        <div className="flex gap-3 pt-2">
                            <button
                                ...
                                className="flex-1 h-11 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-xl transition-all"
                            >
                                Cancel
                            </button>
                            <button
