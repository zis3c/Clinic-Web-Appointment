...
export default function Reports({ auth, metrics, appointments_last_30_days, top_doctors, recent_appointments }) {
        ...
        >
            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 print:max-w-none print:mx-0 print:px-8 print:space-y-0">
                ...
                <div className="flex gap-4 print:hidden">
                    <div className="flex-1 min-w-0 bg-white rounded-2xl shadow-sm border border-gray-100 p-4 border-l-4 border-l-blue-500 hover:shadow-md transition-all">
                        <p className="text-[11px] font-semibold text-gray-400 tracking-wider truncate">Doctors</p>
                        <h3 className="text-lg font-black text-gray-900 mt-0.5">{metrics.total_doctors}</h3>
                    </div>
                    <div className="flex-1 min-w-0 bg-white rounded-2xl shadow-sm border border-gray-100 p-4 border-l-4 border-l-teal-500 hover:shadow-md transition-all">
                        <p className="text-[11px] font-semibold text-gray-400 tracking-wider truncate">Patients</p>
                        <h3 className="text-lg font-black text-gray-900 mt-0.5">{metrics.total_patients}</h3>
                    </div>
                    <div className="flex-1 min-w-0 bg-white rounded-2xl shadow-sm border border-gray-100 p-4 border-l-4 border-l-purple-500 hover:shadow-md transition-all">
                        <p className="text-[11px] font-semibold text-gray-400 tracking-wider truncate">Schedules</p>
                        <h3 className="text-lg font-black text-gray-900 mt-0.5">{metrics.total_schedules}</h3>
                    </div>
                    <div className="flex-1 min-w-0 bg-white rounded-2xl shadow-sm border border-gray-100 p-4 border-l-4 border-l-rose-500 hover:shadow-md transition-all">
                        <p className="text-[11px] font-semibold text-gray-400 tracking-wider truncate">Bookings (30d)</p>
                        <h3 className="text-lg font-black text-gray-900 mt-0.5">{appointments_last_30_days}</h3>
                    </div>
                </div>
