                         ...
                         <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700 table-fixed">
                            <thead className="bg-gray-50 dark:bg-slate-800 sticky top-0 z-10 ring-1 ring-gray-200 dark:ring-slate-700">
                                <tr>
                                    ...
                                    ></th>
                                    <th 
                                        className="px-6 py-4 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider whitespace-nowrap align-middle"
                                        style={{
                                    ...
                                    <th 
                                        className="px-6 py-4 text-right text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider whitespace-nowrap align-middle"
                                        style={{
                                            width: '10%',
                                            transition: 'all 350ms cubic-bezier(0.4, 0, 0.2, 1)'
                                        }}
                                    ...
                                    return (
                                        <Fragment key={`group-${group.scheduleId}`}> 
                                            ...
                                            <tr 
                                                ...
                                                className={`cursor-pointer transition-colors ${isExpanded ? 'bg-blue-50/30 dark:bg-blue-900/10' : 'hover:bg-blue-50 dark:hover:bg-slate-700/50'}`}
                                            >
                                                <td 
                                                    ...
                                                    >
                                                        {isBulkMode && (
                                                            <input 
                                                                ...
                                                                className="w-4 h-4 rounded border-gray-300 dark:border-slate-600 text-blue-600 dark:bg-slate-700 focus:ring-blue-500 cursor-pointer"
                                            ...
                                            {isExpanded && group.appointments.map((apt: any) => (
                                                <tr 
                                                    ...
                                                    className={`cursor-pointer transition-colors bg-gray-50/50 dark:bg-slate-800/50 border-b border-gray-100 dark:border-slate-700/50 ${
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-3 whitespace-nowrap" colSpan={2}>
                                                        <div className="flex items-center">
                                                            ...
                                                            <div className="ml-3">
                                                                <div className="text-sm font-bold text-gray-900 dark:text-slate-100">{apt.patient.user.name}</div>
                                                                <div className="text-xs text-gray-500 dark:text-gray-400">{apt.patient.tel}</div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                            ...
                                                            {apt.status !== 'rejected' && apt.status !== 'completed' && (
                                                                <>
                                                                    ...
                                                                    <button 
                                                                        ...
                                                                        className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 bg-gray-50 dark:bg-slate-700 hover:bg-gray-100 dark:hover:bg-slate-600 p-2 rounded-xl border border-gray-200 dark:border-slate-600 transition-all shadow-sm hover:scale-105 active:scale-95 cursor-pointer"
                                                                    >
                                                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
