...
export default function Reports({ auth, metrics, appointments_last_30_days, top_doctors, recent_appointments }: any) {
    ...
    return (
        ...
        >
            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4 print:max-w-none print:mx-0 print:px-8 print:space-y-0 flex flex-col lg:h-[calc(100vh-70px)] lg:overflow-hidden pb-8 lg:pb-0">
                
                {/* ===== SCREEN ONLY: Header Bar ===== */}
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white dark:bg-slate-800 p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all print:hidden gap-4 md:gap-0">
                    <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 print:hidden">
                    ...
                    <div className="relative overflow-hidden bg-gradient-to-br from-blue-500/5 via-white to-white dark:from-blue-900/20 dark:via-slate-800 dark:to-slate-800 rounded-2xl shadow-sm border-t border-r border-b border-gray-100 dark:border-slate-700 border-l-4 border-l-blue-600 p-4 hover:shadow-md hover:-translate-y-0.5 transition-all group flex justify-between items-center">
                        <div className="min-w-0">
                            <p className="text-[10px] font-bold text-blue-500/80 dark:text-blue-400 capitalize tracking-widest truncate">Doctors</p>
                    ...
                    <div className="relative overflow-hidden bg-gradient-to-br from-teal-500/5 via-white to-white dark:from-teal-900/20 dark:via-slate-800 dark:to-slate-800 rounded-2xl shadow-sm border-t border-r border-b border-gray-100 dark:border-slate-700 border-l-4 border-l-teal-600 p-4 hover:shadow-md hover:-translate-y-0.5 transition-all group flex justify-between items-center">
                        <div className="min-w-0">
                            <p className="text-[10px] font-bold text-teal-600/80 dark:text-teal-400 capitalize tracking-widest truncate">Patients</p>
                    ...
                    <div className="relative overflow-hidden bg-gradient-to-br from-purple-500/5 via-white to-white dark:from-purple-900/20 dark:via-slate-800 dark:to-slate-800 rounded-2xl shadow-sm border-t border-r border-b border-gray-100 dark:border-slate-700 border-l-4 border-l-purple-600 p-4 hover:shadow-md hover:-translate-y-0.5 transition-all group flex justify-between items-center">
                        <div className="min-w-0">
                            <p className="text-[10px] font-bold text-purple-600/80 dark:text-purple-400 capitalize tracking-widest truncate">Schedules</p>
                    ...
                    <div className="relative overflow-hidden bg-gradient-to-br from-rose-500/5 via-white to-white dark:from-rose-900/20 dark:via-slate-800 dark:to-slate-800 rounded-2xl shadow-sm border-t border-r border-b border-gray-100 dark:border-slate-700 border-l-4 border-l-rose-600 p-4 hover:shadow-md hover:-translate-y-0.5 transition-all group flex justify-between items-center">
                        <div className="min-w-0">
                            <p className="text-[10px] font-bold text-rose-500/80 dark:text-rose-400 capitalize tracking-widest truncate">Bookings (30d)</p>
                ...
                <div className="hidden print:block">
                    ...
                    <div className="mb-6">
                        <h2 className="text-sm font-bold text-gray-900 capitalize tracking-widest border-b border-gray-300 pb-1 mb-3">1. Executive Summary</h2>
                    ...
                    <div className="mb-6">
                        <h2 className="text-sm font-bold text-gray-900 capitalize tracking-widest border-b border-gray-300 pb-1 mb-3">2. Doctor Activity Ranking</h2>
                    ...
                    <div className="mb-6">
                        <h2 className="text-sm font-bold text-gray-900 capitalize tracking-widest border-b border-gray-300 pb-1 mb-3">3. Recent Appointment Records</h2>
                ...
                {/* ===== SCREEN ONLY: Tables ===== */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 print:hidden lg:flex-1 lg:min-h-0">
                    {/* Most Active Doctors */}
                    <div className="bg-white dark:bg-slate-800 overflow-hidden shadow-sm rounded-2xl border border-gray-100 dark:border-slate-700 flex flex-col lg:h-full lg:min-h-0 transition-all">
                        ...
                        <div className="overflow-x-auto overflow-y-auto custom-scrollbar flex-1 min-h-0 hidden md:block">
                            <table className="min-w-full min-w-[500px] divide-y divide-gray-200 dark:divide-slate-700">
                                <thead className="bg-gray-50/80 dark:bg-slate-800/80 backdrop-blur-md sticky top-0 z-10 ring-1 ring-gray-200 dark:ring-slate-700">
                                    <tr>
                                        <th className="pl-8 pr-4 py-3.5 text-left text-xs font-bold text-gray-500 dark:text-gray-400 capitalize tracking-wider w-16">Rank</th>
                                        <th className="px-4 py-3.5 text-left text-xs font-bold text-gray-500 dark:text-gray-400 capitalize tracking-wider">Doctor</th>
                                        <th className="pl-6 pr-8 py-3.5 text-right text-xs font-bold text-gray-500 dark:text-gray-400 capitalize tracking-wider">Sessions</th>
                                    </tr>
                                </thead>
                                <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                                    {top_doctors.map((doctor: any, index: any) => (
                                        <tr key={doctor.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-all">
                        ...
                        {/* Mobile view for Most Active Doctors */}
                        <div className="md:hidden flex flex-col gap-3 p-4">
                            {top_doctors.map((doctor: any, index: any) => (
                                <div key={`mob-top-${doctor.id}`} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-700/30 rounded-xl border border-gray-100 dark:border-slate-700">
                                    <div className="flex items-center gap-3 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            <div className="text-sm font-bold text-gray-900 dark:text-slate-100 truncate w-full">{doctor.user.name}</div>
                                            <div className="text-xs text-gray-500 dark:text-gray-400 truncate w-full">{doctor.specialty?.name || 'General'}</div>
                                        </div>
                                    </div>
                            ...
                            {top_doctors.length === 0 && (
                                <div className="p-6 text-center text-gray-500 dark:text-gray-400">No doctors found.</div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 overflow-hidden shadow-sm rounded-2xl border border-gray-100 dark:border-slate-700 flex flex-col lg:h-full lg:min-h-0 transition-all">
                        ...
                        <div className="overflow-x-auto overflow-y-auto custom-scrollbar flex-1 min-h-0 hidden md:block">
                            <table className="min-w-full min-w-[500px] divide-y divide-gray-200 dark:divide-slate-700">
                                <thead className="bg-gray-50/80 dark:bg-slate-800/80 backdrop-blur-md sticky top-0 z-10 ring-1 ring-gray-200 dark:ring-slate-700">
                                    <tr>
                                        <th className="pl-8 pr-4 py-3.5 text-left text-xs font-bold text-gray-500 dark:text-gray-400 capitalize tracking-wider w-16">Rank</th>
                                        <th className="px-4 py-3.5 text-left text-xs font-bold text-gray-500 dark:text-gray-400 capitalize tracking-wider">Patient</th>
                                        <th className="pl-6 pr-8 py-3.5 text-right text-xs font-bold text-gray-500 dark:text-gray-400 capitalize tracking-wider">Session</th>
                                    </tr>
                                </thead>
                                <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                                    {recent_appointments.map((appointment: any, index: any) => (
                        ...
                        {/* Mobile view for Recent Appointments */}
                        <div className="md:hidden flex flex-col gap-3 p-4">
                            {recent_appointments.map((appointment: any, index: any) => (
                                <div key={`mob-recent-${appointment.id}`} className="flex flex-col gap-3 p-4 bg-gray-50 dark:bg-slate-700/30 rounded-xl border border-gray-100 dark:border-slate-700">
                                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-slate-700 pb-2">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 capitalize tracking-wider">Patient</span>
                                        </div>
                                        <div className="text-sm font-bold text-gray-900 dark:text-slate-100">{appointment.patient.user.name}</div>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="text-gray-900 dark:text-slate-100 font-medium">Dr. {appointment.schedule.doctor.user.name}</span>
                                    </div>
                                    
                                    <div className="flex justify-between items-center text-sm">
                                        <span className="text-gray-500 dark:text-gray-400">Date</span>
                                        <div className="text-right">
                                            <div className="text-gray-900 dark:text-slate-100 font-medium">{new Date(appointment.schedule.date).toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric' })}</div>
                                            <div className="text-xs text-gray-500 dark:text-gray-400">{formatTime(appointment.schedule.time)}</div>
                                        </div>
                                    </div>
                                </div>
                            ))}
                            {recent_appointments.length === 0 && (
                                <div className="p-6 text-center text-gray-500 dark:text-gray-400">No recent appointments found.</div>
                            )}
                        </div>
                    </div>
                </div>
